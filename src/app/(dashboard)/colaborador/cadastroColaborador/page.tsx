...
const CadastroColaborador = () => {
  ...
  const handleCreateColaborador = async (data: createNewColaboradordata) => {
    try {
      const areasAtuacaoColaboradorData = areaColaborador.map(area => ({
        colaborador_id: data.id || 0,
      ...
      const colaboradorData = {
        ...
        areasAtuacaoColaborador: areasAtuacaoColaboradorData,
        ColaboradorProjeto: colaboradorProjetoData,
      };

      await colaboradorRequest.create(colaboradorData);
